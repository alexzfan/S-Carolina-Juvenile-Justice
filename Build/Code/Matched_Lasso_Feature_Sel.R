...
# write it to csv
write_csv(LASSO_Effects, "../Output/Matched_Lasso_effects_pros.csv")
...
write_csv(Important_Coefs, "../Output/Matched_Important_Coefs.csv")
...
write_csv(LASSO_Effects_dis, "../Output/Matched_Lasso_effects_dis.csv")
...
write_csv(LASSO_Effects_div, "../Output/Matched_Lasso_effects_div.csv")
